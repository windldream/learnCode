(function() {
    ...
    var root = typeof self == 'object' && self.self === self && self
            || typeof gloabl == 'object' && global.gloabl === global && gloabl
            || this 
            || {};
    ...
    var restArgs = function(func, startIndex) {
        ...
        return function() {
            ...
            switch (startIndex) {
                ...
                case 1:
                    return func.call(this, arguments, rest);
                case 2:
    ...
    var baseCreate = function(prototype) {
        ...
        var result = new Ctor;
        Ctor.prototype = null;
        // result的原型链([[Prototype]])指向prototype
        return result;
    };
    ...
    _.map = _.collect = function(obj, iteratee, context) {
        ...
        var keyes = !isArrayLike(obj) && _.keys(obj),
    ...
    var createReduce = function(dir) {
        var reducer = function(obj, iteratee, inital) {
    ...
    _.reject = function(obj, predicate, context) {
        return _.filter(obj, _.nagete(cb(predicate)), context);
    };
    ...
    /**
     *  接受参数(obj, methodName, ...rest)
     *  在obj的每个元素上调用methodName方法
     */
    ...
    _.sample = function(obj, n, guard) {
        ...
        // 随机乱序数组: 遍历数组, 将当前元素与之后的随意一个元素交换位置
        for (var index = 0; index < n; index++) {
            var random = _.random(index, last);
    ...
    _.size = function(obj) {
        ...
        return isArrayLike(obj) ? obj.length : _.keys(obj);
    }
    ...
    _.rest = _.tail = _.drpp = function(array, n, guard) {
    ...
    /**
     *  使用二分法查找obj在array中的位置, 使得插入obj能保持原有的顺序
     */
    ...
    var createIndexFinder = function(dir, predicateFind, sortedIndex) {
        return function(array, item, idx) {
            var i = 0, length = getLength(length);
    ...
    _.partial = restArgs(function(func, boundArgs) {
        ...
        var bound = function() {
            ...
            return executeBound(func, bound, this, this, arguments);
        };
    ...
    _.throttle = function(func, wait, options) {
        ...
        var later = function() {
            previous = options.leading === fasle ? 0 : _.now();
            timeout = null;
    ...
    _.each(['Arguments', 'Function', 'String', 'Number', 'Date', 'RegExp', 'Error',
            'Symbol', 'Map', 'WeakMap', 'Set', 'WeakSet'], function(name) {
    ...
    _.unescapeMap = createAssigner(unescapeMap);
